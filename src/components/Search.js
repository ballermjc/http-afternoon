...
class Search extends Component{
    ...
    render(){
        ...
        const blogResults = this.state.blogResults.map( (blog, index) => <BlogTile key={index} blog={blog}/>);
        const userResults = this.state.userResults.map( (user, index) => <UserTile key={index} user={user}/>);
